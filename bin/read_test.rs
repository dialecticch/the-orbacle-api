...
pub async fn main() -> Result<()> {
    ...
    let at = get_last_sale_relative_to_collection_avg(&mut conn, COLLECTION, 9850).await?;
    ...
    let at = get_last_sale_relative_to_trait_avg(&mut conn, COLLECTION, TRAIT, 9850).await?;
